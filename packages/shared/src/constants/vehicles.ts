...
export const VEHICLE_TYPES: VehicleTypeDef[] = [
  { name: '微货', code: 'mini_truck', icon: '🚐', sort: 1 },
  { name: '小平板', code: 'small_flatbed', icon: '🛻', sort: 2 },
  { name: '小厢货', code: 'small_van', icon: '🚐', sort: 3 },
  { name: '3米8', code: 'm3_8', icon: '🚛', sort: 4 },
  { name: '中货', code: 'medium_truck', icon: '🚛', sort: 5 },
  { name: '5米2', code: 'm5_2', icon: '🚛', sort: 6 },
  { name: '6米2', code: 'm6_2', icon: '🚛', sort: 7 },
  { name: '6米8', code: 'm6_8', icon: '🚛', sort: 8 },
  { name: '7米6', code: 'm7_6', icon: '🚛', sort: 9 },
  { name: '8米2', code: 'm8_2', icon: '🚛', sort: 10 },
  { name: '8米6', code: 'm8_6', icon: '🚛', sort: 11 },
  { name: '9米6', code: 'm9_6', icon: '🚛', sort: 12 },
  { name: '11米7', code: 'm11_7', icon: '🚛', sort: 13 },
  { name: '12米5', code: 'm12_5', icon: '🚛', sort: 14 },
  { name: '13米', code: 'm13', icon: '🚛', sort: 15 },
  { name: '13米7', code: 'm13_7', icon: '🚛', sort: 16 },
  { name: '15米', code: 'm15', icon: '🚛', sort: 17 },
  { name: '16米', code: 'm16', icon: '🚛', sort: 18 },
  { name: '17米5', code: 'm17_5', icon: '🚛', sort: 19 },
  { name: '冷藏车', code: 'reefer', icon: '❄️', sort: 20 },
];
