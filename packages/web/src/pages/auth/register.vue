...
.btn-register { width: 100%; height: 50px; background: var(--color-primary); color: #fff; border: none; border-radius: var(--radius-round); font-size: var(--font-size-lg); font-weight: 600; cursor: pointer; margin-top: 20px; transition: transform 0.1s; }
.btn-register:disabled { opacity: 0.6; cursor: not-allowed; }
.btn-register:active { transform: scale(0.98); background: var(--color-primary-dark); }
